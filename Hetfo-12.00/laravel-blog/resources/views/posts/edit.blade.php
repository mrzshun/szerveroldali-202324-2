                                ...
                                @foreach ($chunks as $category)
                                    <div class="form-check">
                                        <input type="checkbox"
                                            ...
                                            @checked(in_array($category->id, old('categories', $post->categories->pluck('id')->toArray()))) {{-- TODO: name, checked --}}>
                                        {{-- TODO --}}
                    ...
                    <div class="form-group">
                        <div class="form-check">
                            ...
                            <input type="checkbox" class="form-check-input" value="1" id="remove_cover_image"
                                name="remove_cover_image" @checked(old('remove_cover_image',false))>
